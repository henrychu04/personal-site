...
`,
  },
  {
    ...
    title: "A2A Hub",
    description:
      "Registry and management platform for Google's A2A protocol agents. Validate, register, monitor, and monetize agents — npm meets Uptime Robot for autonomous agents.",
    longDescription:
