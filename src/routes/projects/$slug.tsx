...
function ProjectDetail() {
  ...
  return (
    <div>
      ...
      <section className="mb-8">
        <h2 className="text-xs uppercase tracking-widest text-[#787878] mb-3">Problem</h2>
        <p className="text-sm">{project.problem}</p>
      </section>

      <section className="mb-8">
        <h2 className="text-xs uppercase tracking-widest text-[#787878] mb-3">Solution</h2>
        <p className="text-sm">{project.solution}</p>
      </section>

      {project.architecture && (
        <section className="mb-8">
          <h2 className="text-xs uppercase tracking-widest text-[#787878] mb-3">Architecture</h2>
      ...
      {project.tables?.map((table, i) => (
        <section key={i} className="mb-8">
          <h2 className="text-xs uppercase tracking-widest text-[#787878] mb-3">{table.title}</h2>
